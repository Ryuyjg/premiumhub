...
export const STARTER_PRODUCTS: StarterProduct[] = [
  ...
  { name: "Steam Wallet Top-up", categoryName: "Gaming", description: "Steam wallet recharge code for game purchases.", price: 1000, salePrice: 950, durationInDays: 3650, imageUrl: "https://source.unsplash.com/1600x900/?steam,gaming", deliveryMode: "email_invite", features: F.instant },
