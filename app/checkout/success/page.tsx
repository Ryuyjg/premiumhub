  ...
  return (
    <div className="container py-20">
      <div className="mx-auto max-w-xl rounded-3xl border border-border/60 bg-card p-8 text-center shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-black">External checkout is paused</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          This screen is reserved for the next checkout integration. For now, the storefront and account flow stay ready while payment is finalized later.
        </p>
